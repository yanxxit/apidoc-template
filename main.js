require.config({
    paths: {
        ...
        diffMatchPatch: 'https://cdn.bootcss.com/diff_match_patch/20121119/diff_match_patch',
        handlebars: 'https://cdn.bootcss.com/handlebars.js/4.0.12/handlebars.min',
        handlebarsExtended: './utils/handlebars_helper',
        jquery: 'https://cdn.bootcss.com/jquery/3.3.1/jquery.min',
        locales: './locales/locale',
        lodash: 'https://cdn.bootcss.com/lodash.js/4.17.11/lodash.min',
